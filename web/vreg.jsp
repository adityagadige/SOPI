    ...
    <div class="container">
      <div class="row">
		...
		<div class="text-center">
			<h3 style="margin-right:910px;">Vendor Registration</h3>
           ...
           <div class="form-row" style=" margin-right: 50px;">  
                <div class="col-12 col-md-9 mb-2 mb-md-0">
				  ...
				  <input type="text" class="form-control form-control-lg" placeholder="Enter Company Name" style="width: 242px;" name="cname" required><br>
				 <textarea class="form-control form-control-lg" placeholder="Enter Comapany Address" name="address" style="width: 242px;" required></textarea><br>
				  ...
				  <input type="password" class="form-control form-control-lg" placeholder="Re-Enter your password" style="width: 242px;" name="pwdr" required>                          
                                  <input type="hidden" value="5" name="status" /><br>
