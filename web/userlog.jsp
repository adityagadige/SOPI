    ...
    <div class="container">
      <div class="row">
		...
		<div class="text-center">
			<h3 style="margin-right:910px;">User Login</h3>
           ...
           <div class="form-row" style=" margin-right: 50px;">  
                <div class="col-12 col-md-9 mb-2 mb-md-0">
				  ...
				  <input type="hidden" value="3" name="status" /><br>
                  <input type="submit" class="btn btn-lg btn-primary" value="login" style="margin-right: 900px; ">    
                <h5 style="margin-right: 600px;">Not Registered? <a href="ureg.jsp">Click here</a></h5>	  
                </div>
              </div>
            </form>
        </div>
