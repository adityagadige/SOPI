...
<%@page import="java.sql.*"%>
  ...
  <div id="main-content">
    <div class="container">
	 ...
	 <form action="ps1.jsp" method="post" style="margin-right: 1100px;margin-top: 100px;">
...
<br><input type="submit" class="btn btn-lg btn-primary" style="margin-right: 700px;height: 37px;" value="Submit"></button>
