...
<%@page import="java.sql.*"%>
  ...
  <div id="main-content">
    <div class="container">
	 ...
	 <form action="aps2.jsp" method="post" style="margin-left: 800px;margin-top: -150px;">
              <table ><tr>
...
<tr><td width="300px"><label>MANUFACTURE:</label></td><td> <input type="text" class="form-control form-control-lg" value="<%=rs.getString(7)%>" style="width: 242px;" name="mfs" readonly required><br>
</td></tr>
<tr><td width="300px"><label>QUALITY TESTING: </label></td><td><input type="text" class="form-control form-control-lg" value="<%=rs.getString(8)%>" style="width: 242px;" name="qts" readonly required><br>		
</td></tr>
<tr><td width="300px"><label>DELIVERY CHALLAN AND INVOICE :</label> </td><td><input type="text" class="form-control form-control-lg" value="<%=rs.getString(11)%>" style="width: 242px;" readonly name="inv" required><br>
</td></tr>
...
<tr><td width="300px"><label>AGENT NAME :</label> </td><td><input type="text" class="form-control form-control-lg" value="<%=rs.getString(13)%>" style="width: 242px;" name="agent" readonly required><br>
</td></tr>
<tr><td width="200px"><label>INSTALLATION:</label> </td><td><input type="text" class="form-control form-control-lg" value="<%=rs.getString(9)%>" style="width: 242px;" name="inst"  required><br>
</td></tr>


<tr><td width="200px"><label>AMOUNT PAID:</label> </td><td><input type="text" class="form-control form-control-lg" value="<%=rs.getString(10)%>" style="width: 242px;" name="pamt"  required>
</td></tr></table>
<%							}	
}
catch (Exception ex) 
